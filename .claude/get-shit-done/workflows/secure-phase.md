...
```
Task(
  prompt="Read /Users/surapongkawkangploo/Desktop/my/finally/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/surapongkawkangploo/Desktop/my/finally/.claude/get-shit-done/templates/SECURITY.md`
